...
class GridTest {
    ...
    private static final Cell CELL_0_0 = Cell.cellWithValue(0, 0, 1);
    private static final Cell CELL_0_1 = Cell.cellWithValue(0, 1, 2);
    private static final Cell CELL_0_2 = Cell.cellWithValue(0, 2, 3);
    private static final Cell CELL_1_0 = Cell.cellWithValue(1, 0, 4);
    private static final Cell CELL_1_1 = Cell.cellWithValue(1, 1, 5);
    private static final Cell CELL_1_2 = Cell.cellWithValue(1, 2, 6);
    private static final Cell CELL_2_0 = Cell.cellWithValue(2, 0, 7);
    private static final Cell CELL_2_1 = Cell.cellWithValue(2, 1, 8);
    private static final Cell CELL_2_2 = Cell.cellWithValue(2, 2, 9);
